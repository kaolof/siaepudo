  ...
  <div class="content content-full pt-4 pb-4">
    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
      <h1 class="block-title text-uppercase font-w700 pt-1 vertical-align">
        ...
        <span class="ml-2 font-size-md text-black">Gestionar materias</span>
      </h1>
      <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-alt">
          <li class="breadcrumb-item text-black text-uppercase breadcrumb-item-font">SIAEPUDO</li>
          <li class="breadcrumb-item text-black-75 active text-uppercase breadcrumb-item-font-active" aria-current="page">Gestionar materias</li>
        </ol>
      </nav>
    </div>
  </div>
...
<div class="content mb-3">
  <h2 class="content-heading pt-0 mb-0 pb-0 border-bottom font-note text-uppercase">Gestione las materias de oferta académica</h2>
  <!-- Elements -->
  <div class="block block-rounded block-bordered mt-4 block-mode-loading-refresh" id="block-oferta">
    ...
    <div class="block-content">
      ...
      <!-- NÚCLEO SELECT -->
        ...
        <div class="col-3">
          <div class="form-group">
            <label for="example-text-input text" class="text-uppercase font-label-form font-w700">Materia</label>
            {{
              Form::select(
                'id_nucleo',
                $pluck["Nucleos"],
        ...
        <!-- TIPO DE MATERIA MODULAR/SEMESTRAL -->
        <div class="col-3">
          <div class="form-group">
            <label for="example-text-input text" class="text-uppercase font-label-form font-w700">PERIODO</label>
            {{
              Form::select(
                'id_nucleo',
                $pluck["Nucleos"],
         ...
         <div class="col-3">
          <div class="form-group">
            <label for="example-text-input text" class="text-uppercase font-label-form font-w700">Fecha Inicio</label>
            {{
              Form::date(
                'id_nucleo',
                null,
         ...
         <div class="col-3">
          <div class="form-group">
            <label for="example-text-input text" class="text-uppercase font-label-form font-w700">Fecha Finalización</label>
            {{
              Form::date(
                'id_nucleo',
                null,
         ...
         <div class="col-3">
          <div class="form-group">
            <label for="example-text-input text" class="text-uppercase font-label-form font-w700">Docente</label>
            {{
              Form::input(
                'id_nucleo',
                $pluck["Nucleos"],
          ...
          <div class="block block-rounded js-appear-enabled animated fadeIn bg-gray-lighter" data-toggle="appear">
            <div class="block-content block-content-full border-left border-3x border-dark">
              <p class="text-muted mb-0 mt-0 font-size-details text-uppercase font-w700 text-center">
                Información correspondiente de las materias ofertadas en el periodo actual.
              </p>
            </div>
          </div>
          <table class="table table-vcenter table-striped display nowrap table-hover table-bordered" id="table-aspirantes">
            <thead>
                <tr class="text-uppercase font-size-sm text-center">
                    <th class="font-w700">Materia</th>
                    <th class="font-w700">Programa</th>
                    <th class="font-w700">Fecha inicio</th>
                    <th class="font-w700">Fecha finalización</th>
                </tr>
            </thead>
           </table>
        </div>
