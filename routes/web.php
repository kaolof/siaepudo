...
//SOLO USUARIO LOGUIADOS
	Route::middleware(['auth'])->group(function () {
		...
		//SOLICITUDES
		Route::get('/solicitudes/index', 'SolicitudesController@index')->name('solicitudes.index');
		Route::post('/solicitudes/index', 'SolicitudesController@guardar')->name('solicitudes.guardar');
		...
		//GeneradorPDF
		Route::get('/generar-pdf/{comprobante}','SolicitudesPendientesController@generatePDF')->name('solicitudespendientes.generatePDF');
